                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="direccion" id="direccion" class="form-control @error('direccion') is-invalid @enderror" rows="2" required autofocus>{{ old('direccion') }}</textarea>
                        ...
                        <div class="row mb-3">
                            <label for="ci" class="col-md-4 col-form-label text-md-end">{{ __('Carnét de Identidad') }}</label>
