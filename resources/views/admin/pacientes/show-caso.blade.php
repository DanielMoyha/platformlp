...
@section('content')
                ...
                @foreach ($paciente->hijos as $hijo)
                    <div class="d-md-flex justify-content-between shadow-sm rounded-3 mt-2 mt-md-1">
                        ...
                        <div class="col-md-3">
                            ...
                            @if ($hijo->user_id === null || empty($hijo->user_id))
                                <span class="fst-italic text-muted">Sin Encargada</span>
                            @else
                                <span class="fst-italic text-muted">{{ $hijo->user->name }}</span>
                            @endif
                        </div>
                    </div>
                @endforeach
    ...
    <div class="card border-0 shadow my-4">
        ...
        <div class="card-footer text-end bg-transparent">
            <a href="{{ route('home') }}" class="btn btn-danger fw-bold"><i class="fa-solid fa-arrow-left"></i> Regresar</a>
        </div>
    </div>
@endsection
